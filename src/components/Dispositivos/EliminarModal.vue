        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Eliminar Dispositivo</h1>
                ...
                <div class="modal-footer">
                    ...
                    <button @click="eliminarDispositivo" type="button" class="btn btn-primary">Sí, eliminar</button>
                </div>
            </div>
        </div>
    </div>
...
function eliminarDispositivo(){
    ...
    modal.hide();
    axiosFunction.patch(`Dispositivos/EliminarDispositivo/${props.idDispositivo}`)
        .then(() => {
            emit('actualizarDispositivo')
            toast.success("Dispositivo eliminado con exito", {
                autoClose: 5000,
