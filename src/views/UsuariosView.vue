<template>
      ...
      <section class="main-content">
        <div class="headerTable">
          ...
          <div class="search-bar">
            ...
            <button @click="crearUsuario" class="icon-button">
          ...
          <table class="patient-table" v-if="!IsLoading">
            ...
            <tbody class="tableBody">
              <tr v-for="usuario in listaUsuarios.value" :key="usuario.idUsuario">
                ...
                <td>
                  <button class="edit-button" @click="editarUsuario(usuario.idUsuario)">
                    <!-- Botón de editar -->
                  ...
                  <button class="delete-button" @click="eliminarUsuario(usuario.idUsuario)">
                    <!-- Botón de eliminar -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
  ...
  <!-- Modales -->
  <EliminarModal :idUsuario="idUsuario" @actualizarUsuarios="listarUsuarios"></EliminarModal>
  <EditarModal v-if="modalShow" :idUsuario="idUsuario" @actualizarUsuarios="listarUsuarios"></EditarModal>
  <CrearModal v-if="modalCrearShow" @actualizarUsuarios="listarUsuarios"></CrearModal>
...
import EliminarModal from '@/components/Usuarios/EliminarModal.vue';
