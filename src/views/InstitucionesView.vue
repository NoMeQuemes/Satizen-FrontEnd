<template>
            ...
            <section class="main-content">
                <div class="headerTable">
                    ...
                    <div class="search-bar">
                        ...
                        <button @click="crearInstitucion" class="icon-button">
                    ...
                    <table class="patient-table" v-if="!IsLoading">
                        ...
                        <tbody class="tableBody">
                            <tr v-for="institucion in listaInstitucionesFiltradas" :key="institucion.idInstitucion">
                                ...
                                <td>{{ institucion.correoInstitucion }}</td>
                                <td>{{ institucion.celularInstitucion }}
                                </td>
                                <td>
                                    <button @click="editarInstitucion(institucion.idInstitucion)" class="edit-button">
                                        <!-- Botón de editar -->
                                    ...
                                    <button @click="eliminarInstitucion(institucion.idInstitucion)"
                                        class="delete-button">
                                        <!-- Botón de eliminar -->
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24">
    ...
    <!-- Modales -->
    <CrearModal v-if="modalCrearShow" @actualizarUsuarios="listarInstituciones"></CrearModal>
    <EditarModal v-if="modalShow" :idInstitucion="idInstitucion" @actualizarInstitucion="listarInstituciones">
    </EditarModal>
    <EliminarModal :idInstitucion="idInstitucion" @actualizarInstitucion="listarInstituciones"></EliminarModal>
